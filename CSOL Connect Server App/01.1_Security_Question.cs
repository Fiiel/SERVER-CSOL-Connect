...
namespace CSOL_Connect_Server_App
{
    public partial class SecurityQuestions : Form
    {
        ...
        {
            MessageBox.Show("Verify your identity by answering your security questions. Keep in mind that this is case sensitive. You will be able to reset/change your password once you answer all the security question correctly.");
        }
